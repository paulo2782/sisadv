			...
			<div class="container">
				<div class="row">
					<div class="col-sm|md|lg|xl-1-12|auto form-control">
						<center><strong><h3>VISUALIZA DADOS PARTE ADVERSA</h3></strong></center>			
					</div>
				</div>
				...
				<div class="col-lg-6">
					<a href="{{ route('conParteAdversa') }}"><button type="button" class="btn btn-info form-control">VOLTAR</button></a>
				</div>
